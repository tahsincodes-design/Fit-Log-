...
const Navbar = () => {
    const { plan, saved } = useWorkoutContext();
    ...
    return (
        <div className="navbar bg-[#0C0D10] text-white px-4 sm:px-8 border-b border-zinc-800">
                ...
                <div className="dropdown lg:hidden">
                    ...
                    <ul
                        ...
                        <li className="mt-2 border-t border-zinc-700 pt-2">
                            <Link href="/Workouts" className="flex justify-between">
                                Plan <span className="badge bg-lime-400 text-black border-none font-bold">{planCount}</span>
                            </Link>
                        </li>
                        <li>
                            <Link href="/Workouts" className="flex justify-between">
                                Saved <span className="badge bg-lime-400 text-black border-none font-bold">{savedCount}</span>
                            </Link>
                        </li>
                    </ul>
                </div>
            ...
            <div className="navbar-end flex items-center gap-5 text-sm font-semibold">
                <Link href="/Workouts" className="flex items-center gap-2 cursor-pointer text-zinc-300 hover:text-white transition">
                    <span>Plan</span>
